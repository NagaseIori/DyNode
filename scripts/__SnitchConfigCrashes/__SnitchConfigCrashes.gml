...
#macro SNITCH_CRASH_CAPTURE_FROM_IDE  false
...
#macro SNITCH_CRASH_NO_CLIPBOARD_MESSAGE  ("DyNode 崩溃了 :( 你可以通过 Github 等方式向开发者反馈错误，这能帮助我们改进DyNode。\n\n错误信息：\n\"" + string(_struct.message) + "\"\n" + string(_struct.stacktrace))
...
#macro SNITCH_CRASH_CLIPBOARD_REQUEST_MESSAGE  ("DyNode 崩溃了 :( 你可以通过 Github 等方式向开发者反馈错误，这能帮助我们改进DyNode。\r\r\r错误信息：\r\"" + string(_struct.message) + "\"\r" + string(_struct.stacktrace) + "\r\r\r需要将错误信息复制到剪贴板吗？")
#macro SNITCH_CRASH_CLIPBOARD_ACCEPT_MESSAGE   ("错误信息已复制到剪贴板。")